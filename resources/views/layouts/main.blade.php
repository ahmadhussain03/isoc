...
<!-- Events -->
    ...
    <div class="main-events d-flex flex-column " >
        ...
        <div class="card bg-transparent border-0 me-4">
            <img src="https://www.isoc.pk/wp-content/uploads/2023/03/nic_event-470x330.jpeg" alt="" style="height: 50vh; width: 34rem;">
            ...
            <div class="event-title d-flex flex-column" >
                <span style="width: 26rem; height: 4rem; font-size: 1.25rem; font-weight: 500; color: #0c0c0c; " class="d-flex align-items-end border-bottom pb-2 ps-5">UNIVERSAL ACCEPTANCE UA DAY</span>
...
<div class="card1" >
  ...
  <div class="box" style=" background-color: #f5f7f5; margin-left: 70px; margin-right: 70px;
  padding: 1rem;
  border-left: 10px solid #29af8a;
  margin-bottom: 6rem;color: #29af8a;font-weight: bold;font-size: 24px;line-height: 36px; text-transform: uppercase;"><span>LATEST NEWS</span></div>

  <div class="card-content">

      <div class="row row-cols-1 row-cols-md-3 g-4 card-heading">
        <div class="col">
          <div class="card card-head">
            <div class="day-time" style="position: absolute; left: 10px; text-align: center; color:#fff;text-transform: uppercase;
            background-color:#29af8a;"><span class="card_span" style="  font-weight: bolder; font-size: 26px;" >01</span><br>sep</div>
            <img src="img/first.jpeg" class="card-img-top" alt="..." style="border-radius: 0;">
            <div class="card-body">
              <h5 class="card-title cards-title">DIGITAL CONNECTIVITY IN PAKISTAN BY MR. PARVEZ IFTIKHAR CONNECT</h5>

              <p class="card-text">
                Mr Parvez Iftikhar An ICT professional with more than 40 (forty) years of practical experience, Parvez Iftikhar is passionate about spreading the fruits of Information Communications Technology (ICT) to everyone, particularly those living in remote rural areas. He is presently working as a consultant in various developing countries of Asia and Africa, mainly for ITU, […]                                    </p>

                <div class=" text-end"><a href="" class="learn-text">LEARN MORE</a></div>
            </div>
          </div>
        </div>
        ...
        <div class="col">
          ...
          <div class="card card-head">
            <div class="day-time" style="position: absolute; background-color:#29af8a; left: 10px; text-align: center; color:#fff;text-transform: uppercase;"><span class="card_span"style="  font-weight: bolder; font-size: 26px;"  >01</span> <br>JUL</div>
            <img src="img/second.jpeg" class="card-img-top" alt="..." style="border-radius: 0;">
            <div class="card-body">
              <h5 class="card-title cards-title">ISOC PAKISTAN CHAPTER TRAINING-PROGRAM-2020</h5>
              <p class="card-text">
                This is a pilot program launched by Internet Society to develop community leaders that will be trained in their area of interest and expected to undertake initiatives for awareness on Internet challenges in their countries.  The program is thus based on important topics of our 2020 Action Plan projects: •Shaping the Internet •Securing Global Routing (MANRS) •Building […]                                    </p>
                <div class=" text-end"><a href="" class="learn-text" >LEARN MORE</a></div>
            </div>
          </div>
        </div>
        ...
        <div class="col  ">
          <div class="card card-head">
            <div class="day-time" style="position: absolute;background-color:#29af8a;  left: 10px; text-align: center; color:#fff;text-transform: uppercase;"><span class="card_span" style="  font-weight: bolder; font-size: 26px;" >26</span> <br>Jun</div>
            <img src="img/thrid.jpeg" class="card-img-top" alt="..." style="border-radius: 0;">
            <div class="card-body">
              <h5 class="card-title cards-title">PANDEMIC PHISHING IS LURING MANY</h5>
              <p class="card-text">
                This Article is an original post on Linkedin A new trend has emerged from the COVID-19 pandemic — that of opportunistic cybercriminals preying on Internet users looking to stay informed on the latest coronavirus updates. In the first quarter of 2020, Google’s Safe Browsing service recorded a steady increase in the number of phishing sites — websites […]                                    </p>
                <div class="text-end"><a href="" class="learn-text">LEARN MORE</a></div>
            </div>
          </div>
        </div>
...
<!-- collaborators -->
<div class="img-silder" style="margin-top: 150px;">

  <div class="box" style=" background-color: #f5f7f5; margin-left: 88px; margin-right: 88px;
  padding: 17px 27px 17px 19px;border-left: 10px solid #29af8a;margin-bottom: 50px;color: #637285;font-size: 31px;line-height: 31px;text-transform: capitalize; font-weight: normal;"><span>Collaborators</span></div>
<div class="logo" style="  display: flex;align-items: center;justify-content: space-around;">

<div class="logo1"><img src="img/2000px-Facebook.svg_.png" width="100px" alt=""></div>
<div class="logo1"><img src="img/google.png" width="100px" alt=""></div>
<div class="logo1"><img src="img/juniper.png" width="100px" alt=""></div>
<div class="logo1"><img src="img/NTT.png" width="100px" alt=""></div>

<div class="logo1"><img src="img/icann.png" width="100px" height="40px" alt=""></div>
